...
export const CONTACT_SECTION = {
  ...
  email: "hello@butterflyclinic.care",
...
export const REACH_US_SECTION = {
  ...
  mapSrc:
    "https://maps.google.com/maps?q=H.+No:+9,+A%2F1,+1%2F257,+beside+Lanco+Hills+Residential+Towers+Road,+Manikonda+Hyderabad,+Telangana+500104&t=&z=14&ie=UTF8&iwloc=&output=embed",
  items: [
    ...
    { label: "Front desk", val: "+91 98765 43210" },
